...
# 	Na_from_host1 = pair_2[5:]
# 	Na_from_host1 = decrypt_rsa(Na_from_host1, d, n)
# 	print("Na: ", Na)
# 	# validate Nb
# 	if Na_from_host1 == Na:
# 		print("Na is valid")
# 		# tahapt3
# 		Na_encrypted = encrypt_rsa(Nb, server_public_key, server_n_key)
...
# 		key_host2forHost1 = encrypt_rsa(key_host2,d,n)
# 		key_host2forHost1 = str(key_host2forHost1)
# 		key_host2forHost1 = encrypt_rsa(key_host2forHost1, server_public_key, server_n_key)
# 		key_host2forHost1 = str(key_host2forHost1)
# 		client_socket.send(key_host2forHost1.encode())
...
# 		elif len(plaintext) == 16:
# 			pass
# 		chipertext = encrypt_client(plaintext,key_host2)
...
# tahap 2
Nb = encrypt_rsa(Nb, client_public_key, client_n_key)
Na_encrypted = encrypt_rsa(Na, client_public_key, client_n_key)
...
# tahap 3
Na_from_host1 = client_socket.recv(1024).decode()
Na_from_host1 = eval(Na_from_host1)
...
if Na_from_host1 == Na:
	print("Na is valid")
	# tahap 4
	key_host1 = client_socket.recv(1024).decode()
	# print("key_host1: ", key_host1)
	key_host1 = eval(key_host1)
	key_host1 = decrypt_rsa(key_host1, d,n )
	key_host1 = eval(key_host1)
	key_host1 = decrypt_rsa(key_host1, client_public_key, client_n_key)

	# Chats
	chipertext_from_host1 = client_socket.recv(1024).decode()
	print("chipertext from host1: ", chipertext_from_host1)
	plaintext = decrypt_client(chipertext_from_host1,key_host1)
...
#         print(f"ciphertext dari client: {ciphertext}")
...
#         message_encode = [ord(char) for char in message]
#         ciphertext = [pow(char,client_public_key,client_n_key) for char in message_encode]
